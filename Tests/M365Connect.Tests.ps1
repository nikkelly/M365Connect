...
Describe 'Module Import' {
    ...
    It 'Should have the correct module version' {
        $module = Get-Module -Name M365Connect | Where-Object { $_.Version -eq '1.0.1' } | Select-Object -First 1
...
Describe 'Module State' {
    It 'Should have initialized MSProfileState' {
        ...
        $mod = Get-Module -Name M365Connect | Where-Object { $_.Version -eq '1.0.1' } | Select-Object -First 1
...
Describe 'PowerShell 7 Compatibility' {
    BeforeAll {
        $script:testMod = Get-Module -Name M365Connect | Where-Object { $_.Version -eq '1.0.1' } | Select-Object -First 1
    }
